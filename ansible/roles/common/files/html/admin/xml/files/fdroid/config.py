...
# in text files!
keystorepass = "oYfNFnOnMB5CePIAUqXXtxd7mXJH2HW9243dYgeaQ4A="
...
keypass = "oYfNFnOnMB5CePIAUqXXtxd7mXJH2HW9243dYgeaQ4A="

# The distinguished name used for all keys.
keydname = "CN=elimupi, OU=F-Droid"
