<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        $apiUrl = "http://DEANVPN001.elimupi.dean/api/connect/unregister?school_code=$code&connect_id=$id";
            ...
            <main class="h-full pb-16 overflow-y-auto">
                <div class="container px-6 mx-auto grid">
                    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
                        Unregister an Elimupi Connect Device.
                    </h2>
                    <!-- General elements -->
                  ...
                  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" METHOD='GET'>
                    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        ...
                        <label class="block mt-4 text-sm">
                          ...
                          <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="001" name="id"/>
                        </label>
                        <label class="block mt-4 text-sm">
