<?php
  // Check if form is submitted
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        $apiUrl = "http://DEANVPN001.elimupi.dean/api/school/update?school_code=$code&name=$name&address1=$address1&address2=$address2&City=$city&district=$district&country=$country";
