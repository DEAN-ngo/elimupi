...
def install_kiwix():
    ...
    cp("./kiwix-tools_linux-armhf-0.9.0/kiwix-manage", "/var/kiwix/bin/") 
    cp("./kiwix-tools_linux-armhf-0.9.0/kiwix-read", "/var/kiwix/bin/") 
    cp("./kiwix-tools_linux-armhf-0.9.0/kiwix-serve", "/var/kiwix/bin/") 
    cp("./kiwix-tools_linux-armhf-0.9.0/kiwix-search", "/var/kiwix/bin/") 
