...
def install_kiwix():
    ...
    sudo("cp ./kiwix-tools*/kiwix-manage", "/var/kiwix/bin/") 
    sudo("cp ./kiwix-tools*/kiwix-read", "/var/kiwix/bin/") 
    sudo("cp ./kiwix-tools*/kiwix-serve", "/var/kiwix/bin/") 
    sudo("cp ./kiwix-tools*/kiwix-search", "/var/kiwix/bin/") 
    sudo("cp ./kiwix-start.pl", "/var/kiwix/bin/kiwix-start.pl") 
    sudo("cp ./kiwix-service", "/etc/init.d/kiwix") 
